...
// Ещё можно было бы добавить в интерфейс возможность перекидывать функциональный объект-компаратор для того, чтобы
// сделать кастомное слияние вместо обычного оператора <. Тогда в неявном интерфейсе для него было бы требование:
// наличие перегрузки оператора круглые скобки, принимающие аргумент типа T
